                ...
                { ({ isSubmitting, setFieldValue }) => (
                    <Form>
                        ...
                        <div className="form-row">
                            ...
                            <TagsListComponent value={tagsList} setValue={setTagsList} suggestions={suggestionsList} />
                        </div>
                        ...
                        <div className="form-row">
                            ...
                            <TagsListComponent value={propertiesList} setValue={setPropertiesList} suggestions={propertiesSuggestions} />
                        </div>
